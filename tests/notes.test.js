...
const notes = [
  { id: '1', category: 'Performance Review', author: 'Laurin Vasquez', content: 'Weekly performance is on track.', createdAt: '2026-06-03T16:00:00.000Z', updatedAt: '2026-06-03T16:00:00.000Z', week: 1 },
  { id: '2', category: 'Call Summary', author: 'Josh Whitman', content: 'Discussed department expectations.', createdAt: '2026-06-09T16:00:00.000Z', updatedAt: '2026-06-09T16:00:00.000Z', week: 2 },
  { id: '3', category: 'Hiring Team', author: 'Heather Preece', content: 'Approved for next semester.', createdAt: '2026-06-12T16:00:00.000Z', updatedAt: '2026-06-12T16:00:00.000Z', week: 3 },
]
...
test('filters notes to the selected performance week', () => {
  assert.deepEqual(filterAndSortNotes(notes, { week: '2' }).map(note => note.id), ['2'])
  assert.deepEqual(filterAndSortNotes(notes, { week: 'all' }).map(note => note.id), ['3', '2', '1'])
})
